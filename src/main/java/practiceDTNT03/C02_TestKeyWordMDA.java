...
public class C02_TestKeyWordMDA {
    ...
    private static void testSonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) { // 0 inci ogrencinin cevaplari[][]

            int sayac = 0;

            for (int j = 0; j < answers[i].length; j++) { // cevaplarin icerisinde dolasiyoruz
