...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        System.out.println("\n ***********");
        elmanBasinaVeSonunaYildiz(meyve); // *elma* *portakal* *uzum* *cilek* *greyfurt* *nar* *mandalina* *armut* *elma* *keciboynuzu* *elma*
        System.out.println("\n ***********");
        System.out.println(karakterSayGoreBuyKucSirKarSayEnBuyIlkUsElm(meyve)); // [keciboynuzu, mandalina, portakal]
...
// SORU2 : List elemanlarının hepsinin basina ve sonuna yildiz ekleyerek yazdiralim
    ...
    public static void elmanBasinaVeSonunaYildiz(List<String> meyve) {
        meyve.
                stream().
                map(t -> "*" + t + "*").
                forEach(Utils::yazdir);
...
// karakter sayısı en buyuk ilk 3 elemanı List halinde return ederek yazdırınız
    ...
    public static List<String> karakterSayGoreBuyKucSirKarSayEnBuyIlkUsElm(List<String> meyve) {
        List<String> sonuc =
                meyve.
                        stream().
